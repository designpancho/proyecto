...
//    function fetch_pedido($limit,$offset){
//       $this->db->limit($limit,$offset);
//    $consulta =$this->db->query("select i.id_duplicaciones, d.nombre_disco,c.nombre, i.cantidad,i.fecha_pedido, i.fecha_entrega, i.valor_total  
...
//        return query;
    ...
    function pedidos($fecha, $nuevafecha){
        $query=$this->db->query("select i.id_duplicaciones, d.nombre_disco,c.nombre, i.cantidad,i.fecha_pedido, i.fecha_entrega, i.valor_total  
                                    ...
                                    join cliente c
                                    on c.rut=i.rut
                                    where i.fecha_entrega between '$fecha' and '$nuevafecha'");
